...
gulp.task('full-no-bump', function() {
  isProd = true;
  return runSequence('clean', 'getversion', 'scripts', 'docs');
});

gulp.task('docs', shell.task(
    ['./node_modules/jsdoc/jsdoc.js ./src/offthread-img/offthread-img.js -d ./docs']));
